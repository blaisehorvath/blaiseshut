...
const IOTModal = (props) => {
    return (
        <div id="iotModal" className="modal fade">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h4 className="modal-title">Lorem ipsum dolor.</h4>
                    </div>
                    <div className="modal-body">
                        ...
                        <img  src="https://camo.githubusercontent.com/98c030084e8d0cfbabed30dd534f0134269263d5/687474703a2f2f7777772e75646f6f2e6f72672f77702d636f6e74656e742f75706c6f6164732f323031332f31322f55444f4f2d69636f6e73322e706e67" alt=""/>
